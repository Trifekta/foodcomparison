...
/**
 * Keeta's new-customer discount, as it actually appears in the app: "50% off
 * 1st order - Min. order AED 45; Save up to AED 25 - 50% OFF New User Gift."
 * Confirmed by a real coupon screenshot, not carried over from an earlier
 * guess. See lib/calculations/new-customer-discount.ts.
 */
export const NEW_CUSTOMER_DISCOUNT_MIN_AED = 45;
export const NEW_CUSTOMER_DISCOUNT_PERCENTAGE = 50;
export const NEW_CUSTOMER_DISCOUNT_MAX_AED = 25;
