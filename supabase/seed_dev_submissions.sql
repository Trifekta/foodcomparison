...
select * from (
  select
    'TRI-260910-0001', 'result_ready', 'Talabat', picked.karama, 82.00,
  ...
  union all
  select
    'TRI-260910-0002', 'result_ready', 'Deliveroo', picked.jvc, 67.50,
  ...
  union all
  select
    'TRI-260910-0003', 'new', 'Careem Food', picked.marina, 95.00,
...
where reference_number in ('TRI-260910-0001','TRI-260910-0002','TRI-260910-0003')
  and not exists (
